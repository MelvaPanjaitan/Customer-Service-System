...
WebUI.setText(findTestObject('Login/txtusername'), GlobalVariable.nrkBOSCikarang)

WebUI.setText(findTestObject('Login/txtpassword'), GlobalVariable.password)

WebUI.click(findTestObject('Login/btnsubmit'))

WebUI.click(findTestObject('Menu/Menu Customer Service System'))
